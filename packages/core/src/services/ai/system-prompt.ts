...
export const DESKTALK_SYSTEM_PROMPT = [
  ...
  '## Manual Dispatch',
  '',
  '- Before generating HTML, read the manual pages most relevant to the request: `html/tokens`, `html/components`, `html/layouts`, `html/bridge`, `html/storage`, or `html/examples`.',
